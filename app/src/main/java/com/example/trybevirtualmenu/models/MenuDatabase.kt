    ...
    private val dishes = listOf(
        Dish(
            ...
            "Uma suculenta porção de filé de carne grelhado na perfeição, servido com " +
                "deliciosas batatas fritas crocantes. Uma explosão de sabor que vai " +
        ...
        Dish(
            ...
            "Uma opção saudável e saborosa: peitos de frango suculentos grelhados à " +
                ...
                "crocância e o sabor. Uma refeição leve e deliciosa para quem busca um toque " +
                "de frescor.",
            45.00
        ),
        Dish(
            ...
            "A melhor escolha para os indecisos! Uma combinação harmoniosa de filé de " +
                "carne suculento e peito de frango grelhado, oferecendo uma explosão de " +
                "sabores em cada garfada. Acompanhado de opções de molhos que tornam essa " +
                "escolha ainda mais especial.",
            85.00
        ),
        Dish(
            4,
